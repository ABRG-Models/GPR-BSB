...
impt_D1_tmp <- read.csv (file="./results/bgbsb1_impt_fixcon/d1spikes.csv", header=FALSE, sep=",");
impt_D1 <- impt_D1_tmp$V1;
evbased_D1_tmp <- read.csv (file="./results/bgbsb1_fixcon/d1spikes.csv", header=FALSE, sep=",");
evbased_D1 <- evbased_D1_tmp$V1;

impt_D2_tmp <- read.csv (file="./results/bgbsb1_impt_fixcon/d2spikes.csv", header=FALSE, sep=",");
impt_D2 <- impt_D2_tmp$V1;
evbased_D2_tmp <- read.csv (file="./results/bgbsb1_fixcon/d2spikes.csv", header=FALSE, sep=",");
evbased_D2 <- evbased_D2_tmp$V1;

impt_FSI_tmp <- read.csv (file="./results/bgbsb1_impt_fixcon/fsispikes.csv", header=FALSE, sep=",");
impt_FSI <- impt_FSI_tmp$V1;
evbased_FSI_tmp <- read.csv (file="./results/bgbsb1_fixcon/fsispikes.csv", header=FALSE, sep=",");
evbased_FSI <- evbased_FSI_tmp$V1;

impt_STN_tmp <- read.csv (file="./results/bgbsb1_impt_fixcon/stnspikes.csv", header=FALSE, sep=",");
impt_STN <- impt_STN_tmp$V1;
evbased_STN_tmp <- read.csv (file="./results/bgbsb1_fixcon/stnspikes.csv", header=FALSE, sep=",");
evbased_STN <- evbased_STN_tmp$V1;

impt_GPe_tmp <- read.csv (file="./results/bgbsb1_impt_fixcon/gpespikes.csv", header=FALSE, sep=",");
impt_GPe <- impt_GPe_tmp$V1;
evbased_GPe_tmp <- read.csv (file="./results/bgbsb1_fixcon/gpespikes.csv", header=FALSE, sep=",");
evbased_GPe <- evbased_GPe_tmp$V1;

impt_SNr_tmp <- read.csv (file="./results/bgbsb1_impt_fixcon/snrspikes.csv", header=FALSE, sep=",");
impt_SNr <- impt_SNr_tmp$V1;
evbased_SNr_tmp <- read.csv (file="./results/bgbsb1_fixcon/snrspikes.csv", header=FALSE, sep=",");
